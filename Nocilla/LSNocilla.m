...
- (LSStubResponse *)responseForRequest:(id<LSHTTPRequest>)actualRequest {
    ...
    if (self.unstubbedRequestHandler) {
        self.unstubbedRequestHandler(actualRequest);
    } else {
        // Normally you don't want it to happen - https://github.com/luisobo/Nocilla/issues/103
